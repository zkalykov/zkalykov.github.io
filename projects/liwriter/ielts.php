...
$text = $_POST['text'];
$task="
You are IELTS essays checker, you have to check essay and give exactly score according to rule how to evalueate essays:
'some text' after reading this, you say for example 'IELTS score: (0-9) '
...
if it is not looks like IELTS essay, say it is not or it is incomplete essay.
If it has not got title of essay, ask to provide on top of essay it is title.
...
if(isset($output["choices"][0]["text"])) {
    ...
    echo "<br><center>Error: No answer found. Please re-submit request ! </center><br>";
}
}
?>
...
<body>
  ...
  <div class="container">
    ...
    <div class="input-container">
      <h2 style="padding-bottom: 10px;">IELTS</h2>
    ...
    <div class="mistakes-container" id="mistakes-container">
      ...
      <?php if(empty($answer)) { ?>
      <div class="mistake"> 
          <img src="ielts_photo.jpg" style="width:90%;">
          <h3>Tips for you for IELTS essay checking :</h3><br>
          <li>Click check button to check your essay</li><br>
          <li>please enter a title of essay on top of text</li><br>
